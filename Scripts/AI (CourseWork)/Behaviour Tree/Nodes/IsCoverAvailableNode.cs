...
public class IsCoverAvailableNode : NodeBT
{
    private CoverBT[] availableCovers;
    private Transform target;
    private EnemyAIVersion3 ai;

    public IsCoverAvailableNode(CoverBT[] availableCovers, Transform target, EnemyAIVersion3 ai)
    {
    ...
    private Transform FindBestCoverSpot()
    {
        ...
        {
            Transform bestSpotInCover = FindBestCoverInSpot(availableCovers[i], ref minAngle);
    ...
    private Transform FindBestCoverInSpot(CoverBT cover, ref float minAngle)
    {
